...
void setupGui()
{
    ...
    lv_style_set_text_font(&timeStyle, LV_STATE_DEFAULT, &DigitalPlaySt48); // вкинул свой шрифт
...
//    lv_style_set_bg_color(&style_btn, LV_STATE_DEFAULT, LV_COLOR_SILVER);
    ...
    lv_style_set_bg_opa(&style_btn, LV_OBJ_PART_MAIN, LV_OPA_0); 
    lv_style_set_bg_color(&style_btn, LV_OBJ_PART_MAIN, LV_COLOR_GRAY);    
...
void updateBatteryLevel()                   // обновляем состояние батареи
{
    TTGOClass *ttgo = TTGOClass::getWatch();
